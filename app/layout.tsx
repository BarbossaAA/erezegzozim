...
export const metadata: Metadata = {
  ...
  description:
    "אבחון רעשים, תיקון והחלפת אגזוזים, דודים, צינורות גמישים, נזילות פליטה, ממירים קטליטיים, ריתוך והכנה לטסט — וגם מערכות פליטה בהתאמה אישית לרכבי אספנות, שטח ורכבים מיוחדים. ארז אגזוזים — משה בקר 18, ראשון לציון.",
  keywords: [
    "אגזוזים",
    "מערכת פליטה",
    "תיקון אגזוז",
  ...
  openGraph: {
    ...
    description:
      "אבחון מדויק ותיקון מקצועי של מערכות פליטה: איתור רעשים ונזילות, ריתוך, החלפת דודים והכנה לטסט — בראשון לציון.",
    locale: "he_IL",
    type: "website",
    url: "/",
    images: [
