...
const PAIRS: { symptom: string; diagnosis: string; detail: string }[] = [
  {
    ...
    detail: "ממיר סתום חוסם את זרימת הגזים, והמנוע מאבד כוח בהאצה.",
  },
  {
    symptom: "רעש צורם או לא רגיל",
    diagnosis: "שבר או סדק במערכת הפליטה",
    detail: "גזים שיוצאים דרך שבר או סדק משנים את הצליל ויוצרים רעש צורם.",
  },
  {
    symptom: "נכשלתם בטסט על זיהום אוויר?",
    diagnosis: "כמה סיבות אפשריות",
    detail:
