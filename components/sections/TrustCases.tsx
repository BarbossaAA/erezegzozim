...
const CASES = [
  {
    ...
    fix: "תושבת שבורה — הוחלפה, המערכת יושרה וחוזקה.",
    result: "נסיעה יציבה ושקטה.",
  },
  {
    title: "ריח גזים אחרי התנעה",
    problem: "ריח חריף שנכנס לתא הנוסעים.",
    fix: "נזילה בצינור הגמיש — הוחלף ונבדקה אטימה.",
    result: "מערכת אטומה, ריח נעלם.",
  },
  {
    title: "רעש עמוק מדי מאחור",
    problem: "האגזוז חזק מהרגיל גם בנסיעה רגועה.",
    fix: "דוד אחורי פגום — הוחלף בהתאמה לרכב.",
    result: "רמת רעש מאוזנת ונעימה.",
  },
];
