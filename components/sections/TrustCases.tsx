...
const CASES = [
  {
    title: "הרכב לא סוחב",
    problem: "הלקוח הגיע אחרי שהרכב איבד כוח ולא הגיב להאצה.",
    fix: "בדקנו את זרימת הגזים ומצאנו ממיר קטליטי סתום, והחלפנו אותו.",
    result: "הרכב חזר לתפקוד מלא וערכי הפליטה חזרו לתקן.",
  },
  {
    title: "ריח גזים אחרי התנעה",
    problem: "ריח חריף נכנס לתא הנוסעים אחרי כל התנעה.",
    fix: "מצאנו דליפה בצינור הגמיש, החלפנו אותו ובדקנו את אטימות המערכת.",
    result: "הריח נעלם והמערכת חזרה לתקינות מלאה.",
  },
  {
    title: "כישלון בטסט על זיהום אוויר",
    problem: "הרכב נפסל בטסט בגלל ערכי פליטה חריגים.",
    fix: "עברנו על מסלול הפליטה כולו, איתרנו את מקור התקלה וטיפלנו בו.",
    result: "הרכב עבר את הבדיקה החוזרת ללא הערות.",
  },
];
      ...
      <div className="container">
        <div className="tc-head">
          ...
          <p className="h-sub">
            ...
            נכון — ברכב היומיומי וגם ברכבים שלא רואים בכל מוסך. עם 40 שנה
            ניסיון, {SITE.owner} בודק את הרכב בעצמו ללא עלות, מסביר לכם מה הוא
            מצא ומבצע את העבודה מתחילתה ועד סופה.
          </p>
        </div>
