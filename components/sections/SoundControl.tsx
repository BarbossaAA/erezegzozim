  ...
  return (
    <section className="sound section" aria-label="שליטה ברעש">
      <div className="container">
        ...
        <p className="h-sub">
          מערכת פליטה תקינה שומרת על איזון בין זרימה שקטה, לניצול מירבי של
          הספק ומומנט המנוע וכתוצאה מזה, חסכון בדלק. ההדמיה ממחישה איך הרכב
          נשמע לפני הטיפול ואחריו, במצבי נסיעה שונים.
        </p>
