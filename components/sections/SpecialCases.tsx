...
const CASES = [
  {
    ...
    steps: [
      [
        "הסיפור",
        "רכב אספנות הגיע אלינו עם צנרת שהגיעה לסוף דרכה, והחלק המקורי כבר לא מיוצר עשרות שנים.",
      ],
      [
        "הדרך",
  ...
  },
  {
    ...
    steps: [
      ...
      [
        "הדרך",
        "בנינו מסלול צנרת חדש עם מרווח גחון מלא וזוויות מעבר נכונות.",
      ],
      [
        "התוצאה",
        "הרכב יורד לשטח בלי דאגות.",
      ],
    ],
  },
];
